...
import {prepare,status,pause,advance,listRuns,knowledge,promptFor,getPacket,claimNative,bindNative} from './workflow.mjs';
...
export async function main(args=process.argv.slice(2)){
  ...
  throw Error('Commands: prepare, start, continue, pause, status, packet, claim, bind, search, index, capture, portfolio');
}
